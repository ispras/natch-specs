...
/bin/sh -c "cp -r /usr/lib64/libvmidb.* /opt/snatch/venv/env/lib64/"
/bin/sh -c "cp -r /usr/lib64/python3/site-packages/vmi/*.so /opt/snatch/venv/env/lib64/python3/site-packages/vmi/"
